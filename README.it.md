...
Nel lightbox viene mostrata una versione a 2400 px (usata sia come anteprima
iniziale sia, finché non arriva l'originale, durante lo zoom) e il pulsante
...
Ingrandire l'anteprima regge fino a un certo punto. Oltre 1,4× viene quindi
